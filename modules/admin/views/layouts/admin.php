...
<? $this->title='Админка'?>
                            ...
                            <div id="main-nav" class="collapse navbar-collapse navStyle ">
                                <ul class="nav " id="mainNav">
                                    ...
                                    <li id="change" class="dropup"> <a href="#" class="dropdown-toggle scroll-link" data-toggle="dropdown"
                                                                       role="button" aria-haspopup="true" aria-expanded="true">потрфолио<span class="caret"></span></a>
    ...
    <div class="container adminMenu">
        <ul>
            <li><a href="<?=\yii\helpers\Url::to(['categories/index'])?>">Категории портфолио</a></li>
            <li><a href="<?= \yii\helpers\Url::to(['albums/index'])?>">Альбомы</a></li>
            <li><a href="<?= \yii\helpers\Url::to(['mail/index'])?>">Сообщения пользователей</a></li>
        </ul>
    </div>
    <div class="container">
    <?=$content?>
